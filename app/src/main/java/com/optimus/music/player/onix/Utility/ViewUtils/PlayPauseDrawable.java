...
/**
 * Created by aribhatt on 11/4/2016.
 */
...
public class PlayPauseDrawable extends Drawable {
    ...
    public PlayPauseDrawable(Context context) {
        ...
        context.getTheme().resolveAttribute(android.R.attr.textColorPrimary, colorTheme, true);
        TypedArray arr = context.obtainStyledAttributes(colorTheme.data, new int[]{android.R.attr.textColorPrimary});
        int col = arr.getColor(0, -1);
        mPaint.setColor(col);
        arr.recycle();
    }
