 ...
 */
public class AppWidgetMaterial extends AppWidgetProvider
{
    Context context;
    ...
    public static String WIDGETMAT = "APPWIDGETMAT";

    private static AppWidgetMaterial instance;

    public static synchronized AppWidgetMaterial getInstance(){
        if(instance == null){
            instance = new AppWidgetMaterial();
        }
        return instance;
    }
