...
public class HeterogeneousAdapter extends RecyclerView.Adapter<EnhancedViewHolder> {
    ...
    /**
     * Adds a {@link Section} to the bottom of this Adapter
    ...
    /**
     * Adds a {@link Section} to a specified index in this Adapter
     * @param section the Section to add
    ...
    /**
     * An extension of {@link Section} that always has exactly one item in
     * the set
    ...
    public static abstract class ListSection<Type> extends Section<Type> {
         ...
         */
        public ListSection(int typeId, @NonNull ArrayList<Type> data) {
            super(typeId);
            mData = data;
        }
         ...
         */
        public void setData(@NonNull ArrayList<Type> mData) {
            this.mData = mData;
        }
