...
public class AppWidgetLarge extends AppWidgetProvider
{
    ...
    public static String WIDGETLARGE = "APPWIDGETLARGE";

    private static AppWidgetLarge instance;

    public static synchronized AppWidgetLarge getInstance(){
        if(instance == null){
            instance = new AppWidgetLarge();
        }
        return instance;
    }
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            RemoteViews remoteViews = new RemoteViews(context.getPackageName(),
                    R.layout.appwidget_mid);

            //defaultConfig(context, appWidgetIds);
    ...
    public void performUpdate(Context context, final int[] appWidgeIds){
        ...
        Bitmap icon = null;
        try {
            remoteViews.setImageViewResource(R.id.notificationIcon, R.drawable.default_album_art_);
            ...
            if(PlayerController.getNowPlaying()!=null) {
                ...
                remoteViews.setImageViewUri(R.id.notificationIcon, Uri.parse(""));
                if(uri!=null)
                    remoteViews.setImageViewUri(R.id.notificationIcon, uri);
                ...
                if (PlayerController.isPlaying()) {
                    remoteViews.setImageViewResource(R.id.notificationPause, R.drawable.ic_pause_white_24dp);
                } else {
                    remoteViews.setImageViewResource(R.id.notificationPause, R.drawable.ic_play_arrow_white_24dp);
                }
            }else{
                remoteViews.setImageViewUri(R.id.notificationIcon, Uri.parse(""));
