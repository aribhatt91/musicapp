...
public final class PlayerController {
    ...
    public static void setQueue(final List<Song> newQueue, final int newPosition) {
        if (Prefs.allowAnalytics(applicationContext) && newQueue!=null && !newQueue.isEmpty()) {
    ...
    public static boolean isPreparing(){
        try {
            return playerService != null && playerService.isPreparing();
        }catch (Exception e){
            return false;
        }
    }
    ...
    public static List<Song> getQueue() {
        ...
        try {
            if(playerService.getQueue()!=null)
