...
public class FavSongViewHolder extends RecyclerView.ViewHolder
    ...
    protected int index;
    JukeBoxActivity.JBAdapter jbAdapter;
    ...
    public FavSongViewHolder(View itemView, ArrayList<Song> songList, JukeBoxActivity.JBAdapter jbAdapter) {
        super(itemView);
        ...
        switch (v.getId()){
            case R.id.instanceMore:
                ...
                String[] options = itemView.getResources()
                        .getStringArray(
                                R.array.queue_options_song_fav
                        );
        ...
        switch (menuItem.getItemId()) {
            ...
            case 5:
                try {
                    ...
                    jb.deleteFav(reference.songId, 1);
                    jbAdapter.removeFavItem(reference, songList.indexOf(reference));
                    songList.remove(reference);
                }catch (Exception e){
                    e.printStackTrace();
                }
                return true;
